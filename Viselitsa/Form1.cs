        ...
        private string[] hangmanStages = new string[]
{
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Правила игры:\n\n" +
                            "1. Начиная игру вы выбираете случайное слово.Тема: животные.\n" +
                            "2. Угадывайте слово, вводя буквы по одной.\n" +
                            "3. Если буква есть в слове, она отображается на экране. Если нет - рисуется часть виселицы.\n" +
                            "4. Если попытаться ввести слово полностью и оно будет не правильным - проигрыш.\n" +
                            "5. Игра продолжается до тех пор, пока игрок не угадает слово или не будет нарисована вся виселица.");
        }
